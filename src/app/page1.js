export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-left p-6">
      ...
      <div className='flex flex-row  px-16 mb-4 items-center border gap-x-2 rounded-md'>
        <img className="emoji" width={18}
          height={18} alt="sry" src={'https://cdn-icons-png.flaticon.com/512/281/281764.png'} />

        <p className='py-3 text-sm'>  Continue with Google</p>
      </div>

      <div className='flex flex-row  px-16 items-center border gap-x-2 mb-16 rounded-md'>
        <img className="emoji " width={18}
      ...
      <button className='py-2 bg-indigo-600 '> Register </button>
